...
function confirm_query($result_set) {//Test if there was a query error
		if(!$result_set){
...
// the current suject array or null
...
function find_seleted_page($public) {
...
function password_encrypt($password) {
	...
	$hash_format = "$2y$10$"; //Tell php use Blowfish with 10 times "cost"
	//$salt = "Salt22CharactersOrMore";
	$salt_length = 22;		//Blowfish salts should be 22 character or more
